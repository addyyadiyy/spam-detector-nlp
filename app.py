...
# ══════════════════════════════════════════
    ...
    <div class='hero-banner'>
        ...
        <p style='color:#FFD6E7; margin-top:10px;'>
            Explore dataset characteristics, text patterns, and model performance.
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col1:
        st.markdown("""
        <div class='team-card'>
        <h4>📌 Spam vs Ham Distribution</h4>
        </div>
        """, unsafe_allow_html=True)
        ...
        st.caption(
            "Figure 1: Shows the imbalance between ham (~87%) and spam (~13%) in the dataset."
        )

    with col2:
        st.markdown("""
        <div class='team-card'>
        <h4>☁️ Spam Word Cloud</h4>
        </div>
        """, unsafe_allow_html=True)
        ...
        st.caption(
            "Figure 2: Most frequent words appearing in spam messages such as 'free', 'call', 'win', and 'urgent'."
        )
    ...
    with col3:
        ...
        st.caption(
            "Figure 3: Most frequent words appearing in legitimate (ham) messages, reflecting conversational language."
        )
    ...
    with col4:
        ...
        st.caption(
            "Figure 4: Top 20 most frequent words across the dataset after preprocessing."
        )
    ...
    with col5:
        ...
        st.caption(
            "Figure 5: Comparison of model accuracies. BoW + Naive Bayes achieved the highest accuracy (98.12%)."
        )
    ...
    with col6:
        ...
        st.caption(
            "Figure 6: Confusion Matrix of the best-performing model (BoW + Naive Bayes), showing very few misclassifications."
        )
    ...
    st.caption(
        "Figure 7: Comparison of Accuracy, Precision, Recall and F1-Score across all machine learning models."
    )
# ══════════════════════════════════════════
# MODEL INFO
# ══════════════════════════════════════════
