...
# ══════════════════════════════════════════
    ...
    st.markdown("""
    <div class='hero-banner'>
        <h1 style='margin:0;'>📈 Visual Analytics Dashboard</h1>
        <p style='color:#FFD6E7; margin-top:10px;'>
            Explore dataset characteristics, text patterns and machine learning model performance.
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col1:
        ...
        st.markdown(
            "<h4 style='text-align:center;color:#7C3D8F;'>📌 Spam vs Ham Distribution</h4>",
            unsafe_allow_html=True
        )
        st.markdown("""
        <div style="
            ...
            font-size:0.85rem;
            color:#7C3D8F;">
            <b>Figure 1.</b> Shows the imbalance between ham (~87%) and spam (~13%)
            in the dataset.
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        st.markdown(
            "<h4 style='text-align:center;color:#7C3D8F;'>☁️ Spam Word Cloud</h4>",
            unsafe_allow_html=True
        )
        st.markdown("""
        <div style="
            ...
            font-size:0.85rem;
            color:#7C3D8F;">
            <b>Figure 2.</b> Most frequent words appearing in spam messages such as
            "free", "call", "win", and "urgent".
        </div>
        """, unsafe_allow_html=True)
        st.markdown("</div>", unsafe_allow_html=True)
    ...
    with col3:
        ...
        st.markdown(
            "<h4 style='text-align:center;color:#7C3D8F;'>💬 Ham Word Cloud</h4>",
            unsafe_allow_html=True
        )
        st.markdown("""
        <div style="
            ...
            font-size:0.85rem;
            color:#7C3D8F;">
            <b>Figure 3.</b> Most frequent words appearing in legitimate (ham)
            messages, reflecting conversational language.
        </div>
        """, unsafe_allow_html=True)
        st.markdown("</div>", unsafe_allow_html=True)
    ...
    with col4:
        ...
        st.markdown(
            "<h4 style='text-align:center;color:#7C3D8F;'>🔤 Top 20 Words</h4>",
            unsafe_allow_html=True
        )
        st.markdown("""
        <div style="
            ...
            font-size:0.85rem;
            color:#7C3D8F;">
            <b>Figure 4.</b> Top 20 most frequent words across the dataset after
    ...
    with col5:
        ...
        st.markdown(
            "<h4 style='text-align:center;color:#7C3D8F;'>🏆 Accuracy Comparison</h4>",
            unsafe_allow_html=True
        )
        st.markdown("""
        <div style="
            ...
            font-size:0.85rem;
            color:#7C3D8F;">
            <b>Figure 5.</b> Comparison of model accuracies. BoW + Naive Bayes
            achieved the highest accuracy of 98.12%.
        </div>
        """, unsafe_allow_html=True)
        st.markdown("</div>", unsafe_allow_html=True)
    ...
    with col6:
        ...
        st.markdown(
            "<h4 style='text-align:center;color:#7C3D8F;'>🎯 Confusion Matrix</h4>",
            unsafe_allow_html=True
        )
        st.markdown("""
        <div style="
            ...
            font-size:0.85rem;
            color:#7C3D8F;">
            <b>Figure 6.</b> Confusion Matrix of the best-performing model
            (BoW + Naive Bayes), showing very few misclassifications.
        </div>
        """, unsafe_allow_html=True)
        st.markdown("</div>", unsafe_allow_html=True)
    ...
    st.markdown(
        "<h4 style='text-align:center;color:#7C3D8F;'>📈 Performance Metrics Comparison</h4>",
        unsafe_allow_html=True
    )
    ...
    <div style="
        ...
        font-size:0.85rem;
        color:#7C3D8F;">
        <b>Figure 7.</b> Comparison of Accuracy, Precision, Recall and F1-Score
        across all machine learning models used in this project.
    </div>
    """, unsafe_allow_html=True)
