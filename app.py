...
# ══════════════════════════════════════════
    ...
    with col1:
        ...
        st.caption("Class distribution of messages in the dataset.")
    ...
    with col2:
        ...
        st.caption("Most common keywords appearing in spam messages.")
    ...
    with col3:
        ...
        st.caption("Vocabulary commonly used in legitimate messages.")
    ...
    with col4:
        ...
        st.caption("Most frequent words after preprocessing.")
    ...
    with col5:
        ...
        st.caption("Performance comparison of all models.")
    ...
    with col6:
        ...
        st.caption("Prediction results of the best-performing model.")
